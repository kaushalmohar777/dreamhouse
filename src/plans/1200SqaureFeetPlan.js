...
function Under1200SqaureFeetPlan() {


    if (localStorage.getItem("Under1200sqftPage") == null) {
        var user = [];
        localStorage.setItem('Under1200sqftPage', JSON.stringify(user));
    }
    const [Under1000sqft, u1000sqft] = useState(JSON.parse(localStorage.getItem('Under1200sqftPage')))
    const getUnder1000sqft = () => {
        fetch(`https://dreamhousemakerz.com/production/wp-json/wp/v2/services?service_category=58`)
            .then(async (res) => res.json())
            .then((res) => {
                localStorage.setItem('Under1200sqftPage', JSON.stringify(res));
                u1000sqft(JSON.parse(localStorage.getItem('Under1200sqftPage')));
            })
    }
                ...
                <div className='container-size'>
                    <div className='plan-inner'>
                        <div className='heading-plan'>
                            <h2> 1000-1200 Sqaure Feet Plan</h2>
...
export default Under1200SqaureFeetPlan;