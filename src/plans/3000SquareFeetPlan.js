...
function Under3000SqaureFeetPlan() {


    if (localStorage.getItem("Under3000sqftPage") == null) {
        var user = [];
        localStorage.setItem('Under3000sqftPage', JSON.stringify(user));
    }
    const [Under3000sqft, u3000sqft] = useState(JSON.parse(localStorage.getItem('Under3000sqftPage')))
    const getUnder3000sqft = () => {
        fetch(`https://dreamhousemakerz.com/production/wp-json/wp/v2/services?service_category=56`)
            .then(async (res) => res.json())
            .then((res) => {
                localStorage.setItem('Under3000sqftPage', JSON.stringify(res));
                u3000sqft(JSON.parse(localStorage.getItem('Under3000sqftPage')));
            })
    }
                ...
                <div className='container-size'>
                    <div className='plan-inner'>
                        <div className='heading-plan'>
                            <h2>2000-3000 Square Feet Plan</h2>
...
export default Under3000SqaureFeetPlan;