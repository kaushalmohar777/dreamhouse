...
function Under2000SqaureFeetPlan() {


    if (localStorage.getItem("Under2000sqftPage") == null) {
        var user = [];
        localStorage.setItem('Under2000sqftPage', JSON.stringify(user));
    }
    const [Under2000sqft, u2000sqft] = useState(JSON.parse(localStorage.getItem('Under2000sqftPage')))
    const getUnder2000sqft = () => {
        fetch(`https://dreamhousemakerz.com/production/wp-json/wp/v2/services?service_category=57`)
            .then(async (res) => res.json())
            .then((res) => {
                localStorage.setItem('Under2000sqftPage', JSON.stringify(res));
                u2000sqft(JSON.parse(localStorage.getItem('Under2000sqftPage')));
            })
    }
                ...
                <div className='container-size'>
                    <div className='plan-inner'>
                        <div className='heading-plan'>
                            <h2>1500-2000 Square Feet Plan</h2>
...
export default Under2000SqaureFeetPlan;